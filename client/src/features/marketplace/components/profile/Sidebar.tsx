...
const Sidebar: React.FC = () => {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', active: true, icon: (
    ...
    { id: 'earnings', label: 'Earnings & Payments', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 9.5c-.5-1-1.5-1.5-3-1.5-2 0-3 1-3 2s1 1.5 3 2 3 1 3 2-1 2-3 2-2.5-.5-3-1.5M12 6v12" />
      </svg>
    )},
  ...
  return (
    <aside className="w-[220px] bg-white border-r border-gray-200 fixed left-0 top-0 h-screen flex flex-col z-30">
      {/* Logo */}
      <div className="px-5 py-4 flex items-center gap-2.5">
        ...
        <span className="text-[19px] font-bold text-gray-900">Zameen 360</span>
      </div>
