    ...
    <div className={styles.section}>
      ...
      <div className={styles.grid3}>
        ...
        <div>
          ...
          <div className={styles.btnRow}>
            {bedOptions.map(b => (
              <button key={b} className={`${styles.numBtn} ${beds===b?styles.numActive:''}`} onClick={()=>handleUpdate({bedrooms: b})}>{b}</button>
            ))}
          </div>
        </div>
        <div>
          ...
          <div className={styles.btnRow}>
            {bathOptions.map(b => (
              <button key={b} className={`${styles.numBtn} ${baths===b?styles.numActive:''}`} onClick={()=>handleUpdate({bathrooms: b})}>{b}</button>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className={styles.grid3}>
        <div>
          ...
          <div className={styles.btnRow}>
            {floorOptions.map(f => (
              <button key={f} className={`${styles.numBtn} ${floors===f?styles.numActive:''}`} onClick={()=>handleUpdate({floors: f})}>{f}</button>
            ))}
          </div>
        </div>
        <div>
          ...
          <div className={styles.btnRow}>
            {parkOptions.map(p => (
              <button key={p} className={`${styles.numBtn} ${parking===p?styles.numActive:''}`} onClick={()=>handleUpdate({parking: p})}>{p}</button>
            ))}
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className={styles.tabRow}>
            {['Unfurnished','Semi-Furnished','Fully Furnished'].map(f => (
              <button key={f} className={`${styles.tab} ${furnishing===f?styles.tabActive:''}`} onClick={()=>handleUpdate({furnishing: f})}>{f}</button>
            ))}
          </div>
        </div>
        <div>
          ...
          <div className={styles.tabRow}>
            {['Ready to Move','Under Construction'].map(p => (
              <button key={p} className={`${styles.tab} ${possession===p?styles.tabActive:''}`} onClick={()=>handleUpdate({possession: p})}>{p}</button>
            ))}
          </div>
        </div>
        <div>
