  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #000000 0%, #0a1f4d 50%, #2b6aff 100%)",
        }}
      >
        <div
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(43, 106, 255, 0.2)" }}
        ></div>
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
        <div
          className="inline-flex items-center space-x-2 border rounded-full px-6 py-2 mb-8"
          style={{
            backgroundColor: "rgba(43, 106, 255, 0.15)",
        ...
        >
          ...
          <span className="text-sm font-medium" style={{ color: "#60a5fa" }}>
            Pakistan's Emerging Real Estate Platform
          </span>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
          ...
          <span
            ...
            style={{
              backgroundImage:
                "linear-gradient(135deg, #60a5fa 0%, #2b6aff 100%)",
            }}
          >
            Zameen 360
          </span>
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Your trusted partner in real estate, providing 360° property Views
          across Pakistan. We turn your property dreams into reality.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #2b6aff 0%, #60a5fa 100%)",
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <div
            ...
            style={{ backgroundColor: "rgba(43, 106, 255, 0.1)" }}
          >
            <div
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-black">
            Building Dreams, <br />
            <span style={{ color: "#2b6aff" }}>Creating Futures</span>
          </h2>

          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              <strong className="text-black">Zameen 360</strong> began with a
              simple yet powerful vision to revolutionize the real estate
              industry in Pakistan by providing transparent, reliable, and
              comprehensive 3D property solutions to every Pakistani.
            </p>
            <p>
              What started as a small team of passionate real estate
              professionals in Lahore has now grown into one of Pakistan's most
              trusted real estate companies, operating across 15+ cities with a
              portfolio spanning residential, commercial, and investment
              properties.
            </p>
            <p>
              Our name "360" represents our commitment to providing a complete,
              all-encompassing view of every property ensuring
              our clients make informed decisions with confidence and peace of
              mind.
            </p>
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            >
              <div className="text-center p-8">
                <div
                  className="w-32 h-32 mx-auto rounded-2xl flex items-center justify-center mb-6 shadow-xl"
                  style={{
                    background:
                      "linear-gradient(135deg, #2b6aff 0%, #60a5fa 100%)",
          ...
          <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4 border border-gray-100">
            <div className="flex items-center space-x-3">
              <div
                ...
                style={{
                  backgroundColor: "rgba(43, 106, 255, 0.1)",
                  color: "#2b6aff",
                }}
              >
                <TrophyIcon />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Trusted across Pakistan our track record of
            excellence defines who we are.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {stats.map((stat, index) => (
            <div key={stat.label} className="text-center group">
              <div
                className="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-4 transition-all group-hover:scale-110 transform duration-300"
                style={{
                  backgroundColor: "rgba(43, 106, 255, 0.2)",
                  color: "#60a5fa",
                }}
              >
                {stat.icon}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 group">
          <div
            className="w-20 h-20 rounded-2xl flex items-center justify-center mb-8 text-white shadow-lg group-hover:scale-110 transition-transform"
            style={{
              background: "linear-gradient(135deg, #2b6aff 0%, #60a5fa 100%)",
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            To democratize real estate in Pakistan by providing transparent,
            technology-driven, and customer-centric property solutions. We aim
            to make property buying, selling, and investing accessible,
            reliable, and hassle-free for every Pakistani — from first-time
            homebuyers to seasoned investors.
          </p>
        ...
        <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 group">
          <div
            className="w-20 h-20 rounded-2xl flex items-center justify-center mb-8 text-white shadow-lg group-hover:scale-110 transition-transform"
            style={{
              background: "linear-gradient(135deg, #60a5fa 0%, #2b6aff 100%)",
              boxShadow: "0 10px 30px rgba(37, 99, 235, 0.45)",
            }}
          >
            <EyeIcon />
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            platform — where every property transaction is secure, transparent,
            and value-driven. We envision a future where finding your perfect
            property is as simple as a few clicks, backed by the trust of a
            dedicated team.
          </p>
          <ul className="space-y-3">
            {[
  ...
  const values = [
    {
      ...
      description:
        "We believe in complete honesty and openness in every transaction. No hidden fees, no surprises — just transparent dealings.",
    },
    {
      icon: <UsersIcon />,
      title: "Customer First",
      description:
        "Our clients are at the heart of everything we do. We go above and beyond to ensure your satisfaction and peace of mind.",
    },
    {
      icon: <TrophyIcon />,
      title: "Excellence",
      description:
        "We strive for excellence in every property listing, every consultation, and every transaction. Quality is our hallmark.",
    },
    {
      icon: <TargetIcon />,
      title: "Innovation",
      description:
        "We leverage cutting-edge technology to provide virtual tours, AI-powered recommendations, and seamless digital experiences.",
    },
    {
      icon: <HandshakeIcon />,
      title: "Integrity",
      description:
        "We operate with the highest ethical standards, ensuring every deal is fair, legal, and in the best interest of our clients.",
    },
    {
      icon: <BuildingIcon />,
      title: "Community Impact",
      description:
        "We are committed to developing communities, creating sustainable living spaces, and contributing to Pakistan's growth.",
    },
  ];
          ...
          {values.map((value) => (
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #2b6aff 0%, #60a5fa 100%)",
                }}
              ></div>
              <div
  ...
  const services = [
    {
      ...
      description:
        "Complete assistance in buying and selling residential, commercial, and agricultural properties across Pakistan.",
      features: [
        "Market Analysis",
        "Price Negotiation",
        "Legal Documentation",
    ...
    },
    {
      ...
      description:
        "Expert investment advice to maximize your ROI with data-driven insights and market forecasts.",
      features: [
        "ROI Analysis",
        "Market Trends",
    ...
    },
    {
      ...
      description:
        "End-to-end property management services including tenant screening, rent collection, and maintenance.",
      features: [
        "Tenant Screening",
        "Rent Collection",
        "Maintenance",
    ...
    },
    {
      ...
      description:
        "We partner with leading banks to help you secure the best mortgage rates and financing options.",
      features: [
        "Bank Partnerships",
        "EMI Calculator",
        "Documentation Help",
    ...
    },
    {
      ...
      description:
        "Complete legal support for property verification, title clearance, transfer, and registration.",
      features: [
        "Title Verification",
        "Transfer Deeds",
        "NOC Processing",
    ...
    },
    {
      ...
      description:
        "360° virtual tours and drone footage to help you explore properties from the comfort of your home.",
      features: [
        "360° Virtual Tours",
        "Drone Photography",
        "HD Video Tours",
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Comprehensive 360° real estate solutions tailored to meet your every
            property need.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div
                className="w-12 h-12 rounded-xl flex items-center justify-center text-white mb-6 font-bold text-lg shadow-lg"
                style={{
                  background:
                    "linear-gradient(135deg, #2b6aff 0%, #60a5fa 100%)",
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            A team of passionate professionals dedicated to making your property
            dreams come true.
          </p>
        </div>
          ...
          {team.map((member) => (
            <div key={member.name} className="group text-center">
              <div className="relative mb-6 inline-block">
                <div
                  className="w-32 h-32 mx-auto rounded-3xl flex items-center justify-center text-white text-3xl font-bold shadow-xl group-hover:shadow-2xl group-hover:scale-105 transition-all duration-300 rotate-3 group-hover:rotate-0"
                  style={{
                    background:
                      "linear-gradient(135deg, #2b6aff 0%, #60a5fa 100%)",
                ...
                <div
                  className="absolute -bottom-2 -right-2 w-8 h-8 rounded-lg flex items-center justify-center shadow-md"
                  style={{ backgroundColor: "#2b6aff" }}
                >
                  <svg
              ...
              <h3 className="text-xl font-bold text-black transition-colors group-hover:text-[#2b6aff]">
                {member.name}
              </h3>
              <p
  ...
  const milestones = [
    {
      ...
      description:
        "Zameen 360 was established in Lahore with a small team of 5 passionate real estate professionals.",
    },
    {
      year: "2016",
      title: "First 100 Properties",
      description:
        "Reached our first milestone of 100 property listings and expanded to Islamabad.",
    },
    {
      year: "2017",
      title: "Digital Platform Launch",
      description:
        "Launched our online property portal, enabling customers to search and explore properties digitally.",
    },
    {
      year: "2018",
      title: "Expanded to 5 Cities",
      description:
        "Extended operations to Karachi, Faisalabad, and Rawalpindi with 50+ team members.",
    },
    {
      year: "2019",
      title: "1000+ Properties Sold",
      description:
        "Celebrated the milestone of 1000+ successful property transactions.",
    },
    {
      year: "2020",
      title: "Virtual Tours Introduced",
      description:
        "Pioneered 360° virtual property tours in Pakistan during the pandemic era.",
    },
    {
      year: "2021",
      title: "Award-Winning Agency",
      description:
        'Recognized as "Best Real Estate Agency" at Pakistan Property Awards.',
    },
    {
      year: "2022",
      title: "10+ Cities Coverage",
      description: "Expanded to 10+ cities with a team of 150+ professionals.",
    },
    {
      year: "2023",
      title: "AI-Powered Platform",
      description:
        "Integrated AI for property recommendations and automated valuations.",
    },
    {
      year: "2024",
      title: "5000+ Properties Sold",
      description:
        "Reached 5000+ property sales milestone with 3500+ happy clients.",
    },
  ];
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            A decade of growth, innovation, and building trust in Pakistan's
            real estate market.
          </p>
        </div>
        ...
        <div className="relative">
          <div
            ...
            style={{
              background: "linear-gradient(180deg, #2b6aff 0%, #60a5fa 100%)",
            }}
          ></div>
              ...
              >
                ...
                >
                  <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow border border-gray-100 group">
                    <span
                      className="inline-block font-bold px-3 py-1 rounded-lg text-sm mb-3"
                      style={{
                        backgroundColor: "rgba(43, 106, 255, 0.1)",
                        color: "#2b6aff",
                      }}
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Don't just take our word for it — hear from the thousands who trust
            Zameen 360.
          </p>
        </div>
        ...
        <div className="flex justify-center mt-8 space-x-2">
          {testimonials.map((_, index) => (
            <button
              ...
              style={
                index === activeIndex ? { backgroundColor: "#2b6aff" } : {}
              }
            />
          ))}
        </div>
...
const WhyChooseUs: React.FC = () => {
  const reasons = [
    {
      ...
      description:
        "Every property listed on Zameen 360 is physically verified by our team to ensure authenticity.",
      stat: "100%",
      statLabel: "Verified",
    },
    {
      ...
      description:
        "We negotiate the best market prices ensuring maximum value for your investment.",
      stat: "15%",
    ...
    },
    {
      ...
      description:
        "Full legal support with document verification and fraud protection at every step.",
      stat: "0%",
    ...
    },
    {
      ...
      description:
        "Our relationship doesn't end at the sale. We provide lifetime after-sale support.",
      stat: "24/7",
      statLabel: "Support",
    },
  ];
  ...
  return (
    <section
      className="py-20 relative overflow-hidden"
      style={{
        background: "linear-gradient(135deg, #2b6aff 0%, #1d4fd6 100%)",
      }}
    >
      <div className="absolute inset-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">
            We don't just sell properties — we build trust, create value, and
            deliver excellence.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((reason) => (
            ...
            >
              ...
              <p className="text-blue-50 text-sm text-center leading-relaxed">
                {reason.description}
              </p>
            </div>
          ))}
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            From Lahore to Karachi, we're expanding our footprint across
          ...
          {cities.map((city) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  <MapPinIcon />
                  <h3 className="font-bold text-black transition-colors group-hover:text-[#2b6aff]">
                    {city.name}
                  </h3>
                </div>
                {city.status === "coming" && (
              ...
              <div className="mt-3 h-1 bg-gray-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: city.status === "active" ? "80%" : "30%",
                    background:
                      "linear-gradient(90deg, #2b6aff 0%, #60a5fa 100%)",
                  }}
                ></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {partners.map((partner) => (
            ...
            >
              <span className="text-gray-500 font-bold text-sm transition-colors group-hover:text-[#2b6aff]">
                {partner}
              </span>
            </div>
          ))}
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Ready to Find Your{" "}
                <span style={{ color: "#60a5fa" }}>Dream Property?</span>
              </h2>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Whether you're buying, selling, or investing — our expert team
                is ready to guide you every step of the way. Let's start your
                journey today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.backgroundColor = "#1d4fd6")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.backgroundColor = "#2b6aff")
                  }
                >
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 text-gray-300">
                  <div
                    ...
                    style={{
                      backgroundColor: "rgba(43, 106, 255, 0.3)",
                      color: "#60a5fa",
                    }}
                  >
                    <PhoneIcon />
                ...
                <div className="flex items-center space-x-4 text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-white">
                      123 Main Boulevard, DHA Lahore, Pakistan
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/20 flex flex-col gap-3">
                <a
                  href="https://apps.apple.com/pk/app/zameen360"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.zameen360"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg transition-colors"
                >
